...
metaDescription: How to install and configure New Relic Infrastructure using Chef.
redirects:
...
<CollapserGroup>
  ...
  >
    ...
    Defines your [New Relic license key](/docs/apis/intro-apis/new-relic-api-keys/#ingest-license-key).
  </Collapser>
